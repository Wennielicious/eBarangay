...
<head>
    ...
    <title>Business Permit - New Business</title>
...
<body>
    ...
    <section>
       ...
       <h5>requirements</h5>
    <div class="container">
        <form action="brgyid2.html" method="post">
           
            <span>*Barangay Clearance for Renovation. If NO RENOVATION, submit Certificate of Non-Renovation from Building Administrator</span>
            <label class="upload-box">
                Click here or Drop files to upload or transfer
                <input type="file" name="proof_of_residency" accept="image/*" required>
            </label>

            <span>*Copy of Security and Exchange Commission (SEC) Articles & By-Laws or Department of Trade and Industry (DTI) Registration</span>
            <label class="upload-box">
                Click here or Drop files to upload or transfer
                <input type="file" name="proof_of_residency" accept="image/*" required>
            </label>
            
            <span>*Contract of Lease or Transfer Certificate of Title (TCT)</span>
            <label class="upload-box">
                Click here or Drop files to upload or transfer
                <input type="file" name="proof_of_residency" accept="image/*" required>
            </label>
            
            <span>*Comprehensive General Liability (CGL) Insurance Policy for Business</span>
            <label class="upload-box">
                Click here or Drop files to upload or transfer
                <input type="file" name="proof_of_residency" accept="image/*" required>
            </label>
            ...
            <div class="button-container">
                <a href="bbpermit.html" class="butt">Back</a>
